...
type CategoryKey = "all" | "residential" | "interior" | "landscape" | "graphic";
...
export default function Home() {
  ...
  const categoryOptions = useMemo(
    () =>
      [
        ...
        { key: "residential" as const, label: t("residentialArchitecture") },
        { key: "interior" as const, label: t("interiorDesign") },
        { key: "landscape" as const, label: t("landscapeArchitecture") },
        { key: "graphic" as const, label: t("graphicDesign") },
      ] as const,
    [t]
  );
    ...
    return [
      {
        ...
        title:
          language === "fr"
            ? "Extension de Maison : De 6 à 10 Chambres"
            : "House Extension: From 6 to 10 Bedrooms",
        description:
          language === "fr"
            ? "Rénovation complète et extension d'une résidence familiale avec optimisation de l'espace et design moderne."
            : "Complete renovation and extension of a family residence with space optimization and modern design.",
        image:
      ...
      },
      {
        ...
        title:
          language === "fr"
            ? "Laboratoire Informatique Moderne"
            : "Modern Computer Laboratory",
        description:
          language === "fr"
            ? "Refonte complète d'un laboratoire informatique avec modélisation 3D détaillée et rendus photoréalistes."
            : "Complete redesign of a computer laboratory with detailed 3D modeling and photorealistic renderings.",
      ...
      },
      {
        ...
        title:
          language === "fr"
            ? "Maison Minimaliste Contemporaine avec Piscine"
            : "Contemporary Minimalist House with Pool",
        description:
          language === "fr"
            ? "Projet résidentiel tropical avec piscine, alliant modernité et harmonie avec l'environnement naturel."
            : "Tropical residential project with pool, combining modernity and harmony with the natural environment.",
        image: "/image_original3.png",
      ...
      },
      {
        ...
        title:
          language === "fr"
            ? "Identité Visuelle Complète - Studio Créatif"
            : "Complete Visual Identity - Creative Studio",
        description:
          language === "fr"
            ? "Création d'une identité visuelle complète incluant logo, charte graphique et supports de communication."
            : "Creation of a complete visual identity including logo, graphic charter and communication materials.",
        image:
          "https://images.pexels.com/photos/196644/pexels-photo-196644.jpeg?auto=compress&cs=tinysrgb&w=800",
        categoryKey: "graphic",
        date: "2024",
        client: language === "fr" ? "Studio Créatif" : "Creative Studio",
        href: "https://tiktok.com/@bini.amed225",
      },
    ];
  }, [language]);
  ...
  const experiences = useMemo<Experience[]>(() => {
    return [
      ...
      },
      {
        ...
        period:
          language === "fr" ? "Juil. 2025 – Déc. 2025" : "Jul 2025 – Dec 2025",
        description:
          language === "fr"
      ...
      },
      {
        id: "edu-2",
        title:
          language === "fr" ? "ARCHITECTURE D’INTÉRIEUR" : "Interior Architecture",
        company:
  ...
  const skills = useMemo(
    () => [
      ...
      {
        name: language === "fr" ? "Dessin Technique" : "Technical Drawing",
        level: 90,
        category: t("drawing"),
      },
      {
        name:
          language === "fr" ? "Illustration Artistique" : "Artistic Illustration",
        level: 88,
        category: t("drawing"),
      },
    ],
  ...
  const services = useMemo(
    () => [
      ...
      },
      {
        ...
        title:
          language === "fr"
            ? "Dessin & Illustration Professionnelle"
            : "Professional Drawing & Illustration",
        description:
          language === "fr"
            ? "Création de dessins techniques, illustrations conceptuelles et œuvres artistiques à la main et en numérique."
            : "Creation of technical drawings, conceptual illustrations and artistic works by hand and digitally.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-200 via-white to-blue-950">
            ...
            <div className="space-y-8 animate-slide-in-left">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <Badge
                    variant="secondary"
                    className="bg-green-100 text-green-800 animate-pulse-3d"
                  >
                  ...
                  <Badge
                    variant="outline"
                    className="hover:bg-orange-50 border-orange-200 transition-colors duration-300"
                  >
              ...
              <div className="flex flex-wrap gap-4">
                <Button
                  size="lg"
                  className="gradient-bg hover-lift shadow-lg text-white font-semibold"
                >
      ...
      >
        <div className="max-w-7xl mx-auto">
            ...
            <Card className="p-6 hover-lift card-3d border-gradient animate-fade-in-scale">
              <CardContent className="p-0">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-slate-600">{t("timezone")}</div>
            ...
            <Card className="p-6 hover-lift card-3d border-gradient animate-fade-in-scale">
              <CardContent className="p-0">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-slate-600">{t("fixedProjects")}</div>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          {/* Skills */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold mb-8 text-center gradient-text animate-bounce-in">
              {t("technicalSkills")}
            </h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project) => (
              <Card
                key={project.id}
                className="overflow-hidden hover-lift card-3d border-gradient animate-fade-in-scale"
              >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <Badge
                        ...
                        className="bg-orange-100 text-orange-800"
                      >
                        {categoryOptions.find((c) => c.key === project.categoryKey)?.label}
                      </Badge>
                    ...
                    {!!project.href && (
                      <Button
                        variant="outline"
                        size="sm"
                        className="w-full border-gradient hover-lift"
                        asChild
                      >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 xl:grid-cols-4 gap-8">
            {services.map((service) => (
              <Card
                key={service.title}
                className="p-8 hover-lift card-3d border-gradient animate-fade-in-scale"
              >
                <CardContent className="p-0 text-center">
                  ...
                  <Button className="mt-6 gradient-bg hover-lift text-white" asChild>
                    <a
